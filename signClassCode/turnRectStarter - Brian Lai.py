...
#	flann = cv2.FlannBasedMatcher(index_params, search_params)
	...
	#while True:
        ...
        upper = np.array([179, 200, 255], dtype = "uint8")     
        ...
        if len(contours) != 0:
            ...
            if w*h > 10: # (int) Area lower limit here
        ...
        #kp_s, des_s = sift.detectAndCompute(frame, None)
        ...
        if len(good) >= MIN_MATCH_COUNT:
            ...
            if M is not None:
                ...
                rect1 = ((intDst[0][0][0], intDst[0][0][1]),(intDst[2][0][0], intDst[2][0][1]))
